...
def fetch_realpython_episodes():
    """Fetches new episodes from RSS from the Real Python Podcast."""
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        scheduler.add_job(
            ...
            max_instances=1,
            # Replaces existing and stops duplicates on restart of app
            replace_existing=True,
        )
        logger.info("Added job: The Real Python Podcast.")

        scheduler.add_job(
            fet_talkpython_episodes,
            trigger="interval",
            minutes=2,
            id="Talk Python Feed",
            max_instances=1,
        ...
        try:
            ...
            logger.info("Keystroke interrupt: stopping scheduler...")
            scheduler.shutdown()
